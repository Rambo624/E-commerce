...
<Link to={`/productdetails/${result._id}`}><button className='mt-24 p-2 bg-blue-600 md:text-base text-xs text-white'>Buy Now</button></Link>
<p className='md:text-base text-xs md:block hidden'>{result.desc}</p>
           </div>
           <div className='md:w-4/12 w-2/12'>
